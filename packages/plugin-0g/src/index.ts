...
import { zgsDownload } from "./actions/storage/download";

export const zgPlugin: Plugin = {
    description: "ZeroG Plugin for Eliza",
    name: "ZeroG",
    actions: [zgsUpload, zgsDownload, zgcListServices, zgcCreateAccount, zgcDepositFund, zgcCallService, zgcSettleFee],
    evaluators: [],
    providers: [],
};
