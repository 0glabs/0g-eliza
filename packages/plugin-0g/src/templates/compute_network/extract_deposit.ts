export const zgcExtractDepositTemplate = `
...
Further select one service from the services list and determine the deposit amount according to the user's intention. The deposit amount is in units of A0GI and extracted deposit amount string should be without units. Users might express this in various ways, such as:
